...
kernel = ['linear', 'poly', 'rbf', 'sigmoid'] # RBF is the highest
gamma = ['scale', 'auto'] # Scale is better
random_state = [1,2,3,4,5] # Both is fine
accuracyArr = []
